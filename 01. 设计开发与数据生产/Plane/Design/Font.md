...
- Maple
- JetBrains Mono 混合， https://github.com/MJDILI/MJJHD_Mono
##### 中文等宽的两种思路

通用做中文等宽字体有两种思路：

- 英文适应中文：sarasa的中文是思源黑体，英文去适应中文，导致英文会比较瘦长20%
- 中文适应英文：上面的 `JetBrains Mono 混合` 是中文去适应英文，导致中文会比较宽20%
- 针对性地均衡两者：英文细10%，中文粗10%。暂时不知道有没有哪种字体使用这种策略，一方面工作量会比较大，另一方面可能变两边不讨好了
