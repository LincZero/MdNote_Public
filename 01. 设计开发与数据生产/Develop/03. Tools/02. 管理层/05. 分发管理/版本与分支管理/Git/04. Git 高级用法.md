...
![How to Pull Request](04. Git 高级用法.assets/How to Pull Request.jpg)
...
- Fork，直译：分流支流
  ...
  - Fork更准确的中文翻译是什么？
    ...
    > 主要翻译成：
    >
    > - **<ruby>复刻<rt>Fork</ruby>** (中文维基同款)
    > - **<ruby>派生<rt>Fork</ruby>** (git软件包里蒋新的翻译)
    > - **<ruby>分叉<rt>Fork</ruby>** (Github中文帮助文档的翻译)
