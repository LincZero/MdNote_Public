...
![一个简单的提交历史。](02.%20分支的新建与合并.assets/basic-branching-1.png)
...
![创建一个新分支指针。](02.%20分支的新建与合并.assets/basic-branching-2.png)
...
![`iss53` 分支随着工作的进展向前推进。](02.%20分支的新建与合并.assets/basic-branching-3.png)
...
![基于 `master` 分支的紧急问题分支（hotfix branch）。](02.%20分支的新建与合并.assets/basic-branching-4.png)
...
![`master` 被快进到 `hotfix`。](02.%20分支的新建与合并.assets/basic-branching-5.png)
...
![继续在 `iss53` 分支上的工作。](02.%20分支的新建与合并.assets/basic-branching-6.png)
...
![一次典型合并中所用到的三个快照。](02.%20分支的新建与合并.assets/basic-merging-1.png)

Figure 24. 一次典型合并中所用到的三个快照

和之前将分支指针向前推进所不同的是，Git 将此次三方合并的结果做了一个新的快照并且自动创建一个新的提交指向它。 这个被称作一次合并提交，它的特别之处在于他有不止一个父提交。

![一个合并提交。](02.%20分支的新建与合并.assets/basic-merging-2.png)
