...
在开发主题和插件时，你可能希望获取所有页面的信息。通过 [useRoutes](https://vuepress.github.io/zh/reference/client-api.html#useroutes) 就可以获取所有页面的路由记录。
...
你可以使用 [resolveRoutePath](https://vuepress.github.io/zh/reference/client-api.html#resolveroutepath) 来解析给定的链接对应的路由路径。
...
你可以使用 [resolveRoute](https://vuepress.github.io/zh/reference/client-api.html#resolveroute) 来解析给定的链接对应的路由信息。
