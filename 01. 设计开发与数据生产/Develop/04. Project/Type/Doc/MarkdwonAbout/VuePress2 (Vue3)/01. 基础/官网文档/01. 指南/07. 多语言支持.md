...
然后，在你的 [配置文件](https://vuepress.github.io/zh/guide/configuration.html#配置文件) 中设置 `locales` 选项：
...
> [!TIPS]
>
> 配置参考： [locales](https://vuepress.github.io/zh/reference/config.html#locales)
...
> [!TIPS]
>
> 配置参考： [默认主题 > locales](https://vuepress.github.io/zh/reference/default-theme/config.html#locales)
