...
你也可以通过 [markdown](https://vuepress.github.io/zh/reference/config.html#markdown) 和 [extendsMarkdown](https://vuepress.github.io/zh/reference/plugin-api.html#extendsmarkdown) 来配置这些内置扩展、加载更多 markdown-it 插件、实现你自己的扩展等。
...
>
> 配置参考： [markdown.anchor](https://vuepress.github.io/zh/reference/config.html#markdown-anchor)
...
- 指向 `.md` 文件的内部链接会被转换为目标页面的 [路由路径](https://vuepress.github.io/zh/guide/page.html#路由)，并且支持绝对路径和相对路径。
- 外部链接会被添加 `target="_blank" rel="noopener noreferrer"` 属性。

建议：对于指向内部 Markdown 文件的链接，尽可能使用相对路径而不是绝对路径。
...
> 链接扩展是由我们的内置插件支持的。
>
> 配置参考： [markdown.links](https://vuepress.github.io/zh/reference/config.html#markdown-links)
...
>
> 配置参考： [markdown.emoji](https://vuepress.github.io/zh/reference/config.html#markdown-emoji)
...
目录中的标题将会链接到对应的 [标题锚点](https://vuepress.github.io/zh/guide/markdown.html#标题锚点)，因此如果你禁用了标题锚点，可能会影响目录的功能。

> [!TIPS]
>
> 目录扩展由 [@mdit-vue/plugin-toc](https://github.com/mdit-vue/mdit-vue/tree/main/packages/plugin-toc) 支持。
>
> 配置参考： [markdown.toc](https://vuepress.github.io/zh/reference/config.html#markdown-toc)

### 代码块

下列代码块扩展是在 Node 端进行 Markdown 解析的时候实现的。这意味着代码块并不会在客户端被处理。

#### 行高亮 (内置插件，ex markdown-it-highlight-lines)
...
>
> 配置参考： [markdown.code.highlightLines](https://vuepress.github.io/zh/reference/config.html#markdown-code-highlightlines)
...
> 行号扩展是由我们的内置插件支持的。
>
> 配置参考： [markdown.code.lineNumbers](https://vuepress.github.io/zh/reference/config.html#markdown-code-linenumbers)

#### 添加 v-pre

由于 [模板语法可以在 Markdown 中使用](https://vuepress.github.io/zh/guide/markdown.html#模板语法)，它也同样可以在代码块中生效。
...
>
> 配置参考： [markdown.code.vPre.block](https://vuepress.github.io/zh/reference/config.html#markdown-code-vpre-block)
...
实际上，`[]` 内的第二部分会被作为代码块标记来处理，因此在上面 [代码块](https://vuepress.github.io/zh/guide/markdown.html#代码块) 章节中提到的语法在这里都可以支持：
...
> 导入代码扩展是由我们的内置插件支持的。
>
> 配置参考： [markdown.importCode](https://vuepress.github.io/zh/reference/config.html#markdown-importcode)

## 在 Markdown 中使用 Vue

这一章节会介绍 Vue 在 Markdown 中一些基本用法。

可以前往 [Cookbook > Markdown 和 Vue SFC](https://vuepress.github.io/zh/advanced/cookbook/markdown-and-vue-sfc.html) 来了解更多内容。
...
> [!TIPS]
>
> 前往 [内置组件](https://vuepress.github.io/zh/reference/components.html) 查看所有内置组件。
>
> 前往 [默认主题 > 内置组件](https://vuepress.github.io/zh/reference/default-theme/components.html) 查看默认主题中的所有内置组件。
...
- 设置 [compilerOptions.isCustomElement](https://v3.vuejs.org/api/application-config.html#compileroptions) 来告诉 Vue 模板编译器不要尝试作为组件来解析它们。 
  ...
  - 对于 `@bundler-webpack` ，设置 [vue.compilerOptions](https://vuepress.github.io/zh/reference/bundler/webpack.html#vue)

  - 对于 `@bundler-vite` ，设置 [vuePluginOptions.template.compilerOptions](https://vuepress.github.io/zh/reference/bundler/vite.html#vuepluginoptions)
