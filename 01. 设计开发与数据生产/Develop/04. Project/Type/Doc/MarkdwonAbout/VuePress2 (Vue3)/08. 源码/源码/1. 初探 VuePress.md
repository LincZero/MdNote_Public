...
![image-20210114185426058](1. 初探 VuePress.assets/4e003359baf34c0cb6755eec8007c4c9tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

看到主逻辑文件只有 cli.js 和 index.js 两个，再看看 package.json：

![image-20210114185924797](1. 初探 VuePress.assets/f69854cbae4e4c9595ed8ab54778ad7ftplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

可知我们平常使用的 `vuepress` 调用的其实就是 cli.js 文件. 再来看看 cli.js 干了什么：

![image-20210114200503449](1. 初探 VuePress.assets/b5bb02964e8a4d82b29e334a1fe2a0cetplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image-20210114201402659](1. 初探 VuePress.assets/7cc8d36abd544200a5ad55855008f318tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

第 38 行开始就将运行方法作为参数放入 wrapcommand 准备执行，dev、build 都来自 node_modules/@vuepress 的 core 文件夹：

![image-20210114201607617](1. 初探 VuePress.assets/ea1269c27294400c88f3e7eea448fd3dtplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image-20210114211314418](1. 初探 VuePress.assets/3c95125c147145baa331cedcec65f3d0tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

进入 @vuepress/core 的 index.js：

![image-20210114211430226](1. 初探 VuePress.assets/89360f5dcee34d419d6711f98baa2073tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image-20210114212219741](1. 初探 VuePress.assets/4274383222ea4e538c0538ea6580051btplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![截屏2021-01-14_下午11_22_44](1. 初探 VuePress.assets/da60c0f2424a4da9b8c06be915ad564ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![image-20210114224725966](1. 初探 VuePress.assets/9a8fd35a36a94c93b995dee2ccebc575tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

进去之后应该什么都看不到，不慌，回刚刚代码的 process 函数里加上一行 debugger，然后重新运行 `yarn docs:dev`，现在回到调控制台就可以按照自己的需要调试了：

![image-20210114224939498](1. 初探 VuePress.assets/a54474ab0b9f492fafa55a1cde624171tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

当执行完 118 行的 `await this.resolvePages()` 之后就可以看到 pages 添加了一个 Page，也就是我们最简网站的 README 文件中包含的 Hello VuePress.

![image-20210114225759622](1. 初探 VuePress.assets/8be0d6b9032941d9851fde3a21602bf5tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)

整个 process 函数走完之后，可以看到在 @vuepress/core 文件夹下生成了临时文件夹 .temp：

![image-20210114230232109](1. 初探 VuePress.assets/a86ad7cd54ff4166b56e2565f6ce0165tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
