...
![](copy3. 目标检测.assets/0107af10b33fcb955cc3c588dfb78d49.png)
...
![](copy3. 目标检测.assets/21b37dcb413e7c86464f88484796420c.png)

下面我再具体讲讲如何为监督学习任务定义目标标签 $y$。

![](copy3. 目标检测.assets/02d85ab36285cd21b5df4d1c253df57e.png)
...
![](copy3. 目标检测.assets/fd37e4750b64a07cc1f29880c9b97261.png)
...
![](copy3. 目标检测.assets/131239883224f03709ddc66d9481c3c7.png)
...
![](copy3. 目标检测.assets/d50ae3ee809da4c728837fee2d055f00.png)
...
![](copy3. 目标检测.assets/623baa12a417a4ffe6d1de210974cabc.png)
...
![](copy3. 目标检测.assets/100b265aefc4b0170fb39ed339e5181a.png)
...
![](copy3. 目标检测.assets/fb7fffc14dc60f98003a8ce20f527ab8.png)
...
![](copy3. 目标检测.assets/2f4e567978bb62fcbec093887de37783.png)
...
![](copy3. 目标检测.assets/2ac2ab6dcdcc0fe26a9833ff9da49bd2.png)

假设这是一张测试图片，首先选定一个特定大小的窗口，比如图片下方这个窗口，将这个红色小方块输入卷积神经网络，卷积网络开始进行预测，即判断红色方框内有没有汽车。

![](copy3. 目标检测.assets/c55f22f302899d5f9d77bef958465660.png)
...
![](copy3. 目标检测.assets/34507c03fbda16049faeb3caf075fe50.png)

重复上述操作，不过这次我们选择一个更大的窗口，截取更大的区域，并输入给卷积神经网络处理，你可以根据卷积网络对输入大小调整这个区域，然后输入给卷积网络，输出0或1。

![](copy3. 目标检测.assets/f2b6d5bfedc5298160bc2628544e315c.png)

再以某个固定步幅滑动窗口，重复以上操作，遍历整个图像，输出结果。

![](copy3. 目标检测.assets/c14524aa0534ed78c433e1cd0a8dff50.png)

然后第三次重复操作，这次选用更大的窗口。

如果你这样做，不论汽车在图片的什么位置，总有一个窗口可以检测到它。

![](copy3. 目标检测.assets/ef8afff4e50fc1c50a46b8443f1d6976.png)
...
![](copy3. 目标检测.assets/d17d151e534753cc6ba17a57a927deb9.png)
...
![](copy3. 目标检测.assets/38be387e37d131e44aff9d7fc9e3488a.png)
...
![](copy3. 目标检测.assets/00c4fb1a1af9b50f0fd0bcf5eacca6ff.png)
...
![](copy3. 目标检测.assets/2a8750d733379aebf58f4354203153f2.png)
...
![](copy3. 目标检测.assets/b33768b46b3a06ff229a153765782b48.png)
...
![](copy3. 目标检测.assets/ad1743ff113f9d30080f63a16c74ed64.png)
...
![](copy3. 目标检测.assets/5fd2f8d039a3bfc5187dfe33f5276235.png)
...
![](copy3. 目标检测.assets/c778140e6b853a26a7c9cd8440cf8a3e.png)

![](copy3. 目标检测.assets/84a6a0505acc165c6600d4b6f03d5e3c.png)
...
![](copy3. 目标检测.assets/447080411189a0a4544747c2380fbda4.png)
...
![](copy3. 目标检测.assets/cd3e263bf279739afe62eb8730b4e167.png)
...
![](copy3. 目标检测.assets/e4bebc707829a1610572f43f8e0995c9.png)
...
![](copy3. 目标检测.assets/fb08477cd3937f7df0deddc1de1d2920.png)
...
![](copy3. 目标检测.assets/98633e9df22fd06cfc21af2e7d39bbb6.png)
...
![](copy3. 目标检测.assets/404fdcba2685b830ae3718d348ab1d75.png)
...
![](copy3. 目标检测.assets/a6d32959543c502ee18765cf20495bc2.png)
...
![](copy3. 目标检测.assets/b6b6ca6167596a180c7bab7296ea850c.png)
...
![](copy3. 目标检测.assets/395c57c64bb792a813a904b135423937.png)
...
![](copy3. 目标检测.assets/0d7ee9b9f455338a8724520841223b11.png)
...
![](copy3. 目标检测.assets/38eea69baa46091d516a0b7a33e5379e.png)
...
![](copy3. 目标检测.assets/18cac7505a1ffa2bcb12362d0a465026.png)
...
![](copy3. 目标检测.assets/03e8758ec8c15b2d83cad23ce5783dee.png)

假设你需要在这张图片里检测行人和汽车，你可能会在上面放个19×19网格，理论上这辆车只有一个中点，所以它应该只被分配到一个格子里，左边的车子也只有一个中点，所以理论上应该只有一个格子做出有车的预测。

![](copy3. 目标检测.assets/a86a2edbb89014e193ab613a162cff58.png)
...
![](copy3. 目标检测.assets/78f2b2a2efdbd6aebe034ce30cda440b.png)
...
![](copy3. 目标检测.assets/074beeacfd9d400fc580171b09a6f3e9.png)
...
![](copy3. 目标检测.assets/514cfeb2d7315eba2b6a29f68eae2879.png)
...
![](copy3. 目标检测.assets/6d0fa2073b280cd0bb111485ee1639e5.png)

接下来剩下的边界框，没有抛弃没有处理过的，你就一直选择概率$p_{c}$最高的边界框，然后把它输出成预测结果，这个过程就是上一张幻灯片，取一个边界框，让它高亮显示，这样你就可以确定输出做出有一辆车的预测。

![](copy3. 目标检测.assets/549430cf442163c7f44ae648e625ca10.png)
...
![](copy3. 目标检测.assets/49b7d68a17e89dd109f96efecc223f5a.png)
...
![](copy3. 目标检测.assets/e001f5f3d2afa76a1c3710bd60bcad00.png)
...
![](copy3. 目标检测.assets/2e357b5b92122660c550dcfb0901519c.png)
...
![](copy3. 目标检测.assets/e94aa7ea75300ea4692682b179834bb4.png)
...
![](copy3. 目标检测.assets/322b15fe615c739ebd1d36b669748618.png)
...
![](copy3. 目标检测.assets/f2c4c2ee9fc4c37a66310e1b6a3da4d8.png)
...
![](copy3. 目标检测.assets/36ff927836cfcd7fee9413e2d34757d8.png)
...
![](copy3. 目标检测.assets/e23084f4a75246f08ea4cedef55f60ab.png)
...
![](copy3. 目标检测.assets/140cd14e52c3f217d053ae0efa2fce81.png)
...
![](copy3. 目标检测.assets/66f8cf8e55eadc1ac01f773515bfbc45.png)
...
![](copy3. 目标检测.assets/23256c4b7b28d62d34a744f5fb5e9c3b.png)
...
![](copy3. 目标检测.assets/e78e4465af892d0965e2b0863263ef8c.png)
...
![](copy3. 目标检测.assets/e6ed1aa3263107d4e189dd75adc060b4.png)
