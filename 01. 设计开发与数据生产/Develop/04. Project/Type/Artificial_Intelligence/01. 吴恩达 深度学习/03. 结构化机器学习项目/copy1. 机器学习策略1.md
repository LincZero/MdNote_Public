...
![](copy1. 机器学习策略1.assets/640a89ae465a58f1d19e05895ef31606.png)
...
![](copy1. 机器学习策略1.assets/7f5034517a97e2091be6f5095fdcb978.png)
...
![](copy1. 机器学习策略1.assets/d5a5576cc7a8ecdd070b7d699a9fef43.png)
...
![](copy1. 机器学习策略1.assets/e43a775bf7328d50e9efd02f5ea8b43d.png)
...
![](copy1. 机器学习策略1.assets/227cb967edc12a61a8c62e50f759fa64.png)
...
![](copy1. 机器学习策略1.assets/24144bd15bb01226dc596457e6e6cfcb.png)
...
![](copy1. 机器学习策略1.assets/e75299b34b8ccb565a1566d2a515f597.png)
...
![](copy1. 机器学习策略1.assets/02f4810d07913df9cf8b80e455c7d3aa.png)
...
![](copy1. 机器学习策略1.assets/e6c1e59416b60745145b91e87fda5ecf.png)

但在这个例子中，你可以马上看出，分类器$A$的$F_1$分数更高。假设$F_1$分数是结合查准率和查全率的合理方式，你可以快速选出分类器$A$，淘汰分类器$B$。

![](copy1. 机器学习策略1.assets/1430998715d7053c88e32a35e495574b.png)
...
![](copy1. 机器学习策略1.assets/cb92cdcf31720499a96ef39447bc80f3.png)
...
![](copy1. 机器学习策略1.assets/d16788ba017b04733720dfe7969ef838.png)
...
![](copy1. 机器学习策略1.assets/f4574276832597fbc9d5977401896d15.png)
...
![](copy1. 机器学习策略1.assets/2909dd41d5ade1e310f86c5d2206f295.png)
...
![](copy1. 机器学习策略1.assets/e318e78d4afa310502a4f49d19d08aa3.png)

通过定义优化和满足指标，就可以给你提供一个明确的方式，去选择“最好的”分类器。在这种情况下分类器B最好，因为在所有的运行时间都小于100毫秒的分类器中，它的准确度最好。

![](copy1. 机器学习策略1.assets/5a32842a5d619a22bd1d6fe8b96e8d62.png)
...
![](copy1. 机器学习策略1.assets/5238b9315a275321ba74d28b79201891.png)
...
![](copy1. 机器学习策略1.assets/21e6a2d4c44c748c706142d4bfb3a2e4.png)
...
![](copy1. 机器学习策略1.assets/9b58410d52dcff1e7b7e18d4dc684a6f.png)
...
![](copy1. 机器学习策略1.assets/d4bfa539f88a0b3fa5cd128340d0670b.png)
...
![](copy1. 机器学习策略1.assets/48bcf6f09684edc2ed1850ece7feef44.png)
...
![](copy1. 机器学习策略1.assets/4027ba175f24c511bc282ccc8a91f75b.png)

这里实际发生的事情是，这个团队花了三个月瞄准一个目标，三个月之后经理突然问"你们试试瞄准那个目标如何？"，这新目标位置完全不同，所以这件事对于这个团队来说非常崩溃。

![](copy1. 机器学习策略1.assets/20a976e5fd70b357fedb38ff13111830.png)
...
![](copy1. 机器学习策略1.assets/9945f6b55d1285342ef08bbbbb0a3d11.png)
...
![](copy1. 机器学习策略1.assets/0ca43733e2fbdb778b6846717397e50f.png)
...
![](copy1. 机器学习策略1.assets/a946c85f961f3dbf0a3324535076a78a.png)
...
![](copy1. 机器学习策略1.assets/f8313f1a0ca63a71d0eb3b3b42453220.png)
...
![](copy1. 机器学习策略1.assets/4abef099fe8437efd8aa47c7097e639d.png)
...
![](copy1. 机器学习策略1.assets/fabea6c50883bf1afaf630d068a4009f.png)
...
![](copy1. 机器学习策略1.assets/12c7390dfc8b80057483de00d0d2c7b7.png)
...
![](copy1. 机器学习策略1.assets/96140fe852c219ca5307026abc7bdd4e.png)
...
![](copy1. 机器学习策略1.assets/2a10911b9711830e17a491d7c20526c5.png)
...
![](copy1. 机器学习策略1.assets/f44d03275801ce5ec97503851eb22ad5.png)
...
![](copy1. 机器学习策略1.assets/e1ef954731399bb4fbf18f2fb99b863a.png)
...
![](copy1. 机器学习策略1.assets/bbeeddabb1800e91b1460deade38e756.png)
...
![](copy1. 机器学习策略1.assets/e94444af122172eecf5df8bdca435d1d.png)
...
![](copy1. 机器学习策略1.assets/ac8eb51425d5dbf663d050398f7e8af8.png)
...
![](copy1. 机器学习策略1.assets/a582a5304dca46ff2f450d934bf7330a.png)
...
![](copy1. 机器学习策略1.assets/ee50ed0c91e4e8ad806e38acff0d7440.png)
...
![](copy1. 机器学习策略1.assets/2d74f75b5b848b51be08ff4e1b6d7d2a.png)
...
![](copy1. 机器学习策略1.assets/2bbcd885234523921d26848bd165e096.png)
...
![](copy1. 机器学习策略1.assets/0e6c143fa42628491f97cbe7213a738d.png)
...
![](copy1. 机器学习策略1.assets/22278fbe6985e418f95f54949b7a456d.png)
...
![](copy1. 机器学习策略1.assets/c628000e1ec9c9153bdbf467e12e9864.png)
...
![](copy1. 机器学习策略1.assets/de2eb0ddc7918f6e9213871e07b8fa56.png)
...
![](copy1. 机器学习策略1.assets/c932bd026edaf04840b78582e89f58f4.png)
...
![](copy1. 机器学习策略1.assets/c457e3e578f7d5c0f5aaf937f46eb8b7.png)
