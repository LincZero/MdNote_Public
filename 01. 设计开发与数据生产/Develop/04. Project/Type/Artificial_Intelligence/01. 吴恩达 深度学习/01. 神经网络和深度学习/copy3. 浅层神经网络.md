...
图3.1.1 :
![](copy3. 浅层神经网络.assets/L1_week3_1.png)
...
![w600](copy3. 浅层神经网络.assets/L1_week3_2.png)
...
![](copy3. 浅层神经网络.assets/L1_week3_3.png)
...
![w600](copy3. 浅层神经网络.assets/L1_week3_4.png)
图3.2.2
...
![w600](copy3. 浅层神经网络.assets/L1_week3_5.png)
图3.3.1
...
![](copy3. 浅层神经网络.assets/L1_week3_6.png)
图3.3.2
...
![w600](copy3. 浅层神经网络.assets/L1_week3_7.png)
图3.3.3
...
![w800](copy3. 浅层神经网络.assets/L1_week3_8.png)
图3.4.1
...
现在 $W^{[1]}$ 是一个矩阵，$x^{(1)},x^{(2)},x^{(3)}$都是**列向量**，**矩阵乘以列向量得到列向量**，下面将它们用图形直观的表示出来:
公式3.17：（嵌套矩阵？）
$$
W^{[1]}  x =
		\left[
...
![w600](copy3. 浅层神经网络.assets/L1_week3_9.jpg)
图3.6.1
...
![w600](copy3. 浅层神经网络.assets/L1_week3_10.png)
图3.8.1
...
![w600](copy3. 浅层神经网络.assets/L1_week3_11.png)
图3.8.2
...
![w600](copy3. 浅层神经网络.assets/L1_week3_12.png)
$g(z) =max (0,z)$
...
**==吴恩达老师认为反向传播的推导是机器学习领域最难的数学推导之一==，矩阵的导数要用链式法则来求**（我也觉得这部分有点难了）
，如果这章内容掌握不了也没大的关系，只要有这种直觉就可以了。还有一点，就是初始化你的神经网络的权重，不要都是0，而是随机初始化，下一章将详细介绍原因。

![image-20220925212615658](copy3. 浅层神经网络.assets/image-20220925212615658.png)
...
![w600](copy3. 浅层神经网络.assets/L1_week3_13.png)
