...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/7b73f4de29ea13d9aba5f49e393d4674.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/75bfa084ea64d99b1d01a393a7c988a6.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/3b45624120e77aea2fcd117cbfdc9bdb.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/651422f74439fd7e648e364d26d21485.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/08307acea7c8db95c1479c611189dbfa.png)

所以在**Python**中，你可以这样做，使`r=-4*np.random.rand()`，然后$a$随机取值，$ a =10^{r}$，所以，第一行可以得出$r \in [ 4,0]$，那么$a \in[10^{-4},10^{0}]$，所以最左边的数字是$10^{-4}$，最右边是$10^{0}$。

![](copy3. 超参数调试、Batch正则化和程序框架.assets/fe47f46414d0c26183e85c7b2e4f2f0a.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/a54d5ea6cd623f741f75e62195f072ca.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/2c4e6d3419beb66ed0163331443c6b40.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/2e3b1803ab468a94a4cae13e89217704.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/bb7feac2d0698b8721bfedbc67cc6289.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/3858f51032e483e215ebbd136dc07431.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/439e7b041ac3d948e5852e8307dd09dd.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/1cbcd20a708281e777d2d0c50e355038.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/a361c621a9a0a1a99b03eef8716c5799.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/5cd1e3dd73e69cbf0b2cbc80fddfa4d9.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/7eed1a2ef94832c54d1765731a57b2b5.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/20949eb2c30cb22ab87eef411f01375d.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/734eeb203b02cca8a978ba61b4803bb5.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/e10ea98faa1ce9fe86ec8bf9f4fef71e.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/3d494a1d3fb25f7fd67f1bdbf8d8e464.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/6216dd90d3483f05f08bd8dc86fc7df6.png)

所以，在网络匹配这个单元的方式，之前可能是用$z^{(1)}$，$z^{(2)}$等等，现在则会用${\tilde{z}}^{(i)}$取代$z^{(i)}$，方便神经网络中的后续计算。如果你想放回$[l]$，以清楚的表明它位于哪层，你可以把它放这。

![](copy3. 超参数调试、Batch正则化和程序框架.assets/c4d0391006609385bc309af394c514f9.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/2d314293ae9aaa67285299267857632f.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/02ae6d8845f468b753c1c4244c312b43.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/55047d3da405778b6272e6722cd28ac6.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/0204b45c1adae38694b26de9b7af2edd.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/27dc60faf8c8e4d8360b4c8091b85355.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/06fa55207f5d245e70db73a7e5e89a68.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/61cee05b5822c9bc97bfdfd88861dfd6.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/79d8bc44c225879e9bc89e352b62502a.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/3711c11e52433b6417227e78b998e849.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/08ab0b778ede091a860048d609048167.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/797be77383bc6b34ddd2ea9e49688cf6.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/b84c6784df7184b0baed8e96453646ac.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/125efc4b05bcba7b0e50d78614d58d1f.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/2f19f3438704a51d217ede3abb4eef3d.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/08f134faa74ebd283a5f5f19be43efab.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/8cd4b32c6febb45c71a1c91394cb1d1a.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/32efeb52697bd9543900bbd38a732e3c.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/f8a80801c51e13947d7f2cafb4a8fe69.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/db19ef11d7b654cc020a5f943806ac38.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/0feb6ee8af40238fc1374131bc517e35.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/fd1f67f2e97e814079607f190111f65f.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/9e64b0cb330797ece66c0a56958bfcca.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/6699883f2e531063e4437cc63c5a2a83.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/e36d502aa68bf9e1a118f5d13e24b134.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/e65ba7b81d0b02d021c33bf0094f4059.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/97ab8f2af0788776bdd486c5f4f40354.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/08e51a30d97c877410fed7f7dbe1203f.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/c791fc935e680ef37ef036723f0f2510.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/fec90de0e70081185c234c215a23d307.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/1dc4bf21b6e38cbe9bdfb729ed969c99.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/7207527be03bc1daec77afb6c29b8533.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/6b825763afc787168a19597da2a38d58.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/01a404ae594bdc5871aec07e9fd478d1.png)

简单来说就是用临时变量$t$将它归一化，使总和为1，于是这就变成了$a^{[L]}$，你注意到向量$z$中，最大的元素是5，而最大的概率也就是第一种概率。

![](copy3. 超参数调试、Batch正则化和程序框架.assets/b433ed42cdde6c732820c57eebfb85f7.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/36802969e1acc8b96bb19506d391efe4.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/2d590b27f3f80bbd31d8af257e3be606.png)



接下来我们来看怎样训练带有**Softmax**输出层的神经网络，
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/ed6ccb8dc9e65953f383a3bb774e8f53.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/d9907b5fd482e355e9c6a4e6b3bdf5f9.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/c357c15e4133152bd8bb262789e71765.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/e342eb0e5cc8031f43fd375084b1f473.png)

有了这个，你就可以计算$dz^{[l]}$，然后开始反向传播的过程，计算整个神经网络中所需要的所有导数。

![](copy3. 超参数调试、Batch正则化和程序框架.assets/1d5eca1724fe08158fb9b53a73691a74.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/acb3843cd1085b0742f39677289890a0.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/2a06f1bc26d2eff88246233ba60fc999.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/66541b3ff40c4c43897a062395420cfa.png)

现在我们运行梯度下降1000次迭代：

![](copy3. 超参数调试、Batch正则化和程序框架.assets/f89f49038463b9f30eb09b10f7c0c438.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/43a90dbd043662008d46f168def244b6.png)

![](copy3. 超参数调试、Batch正则化和程序框架.assets/05ab9534065d6359969bcc947e90bad4.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/c93322e2d42219cd37fb579170abada9.png)

![](copy3. 超参数调试、Batch正则化和程序框架.assets/0c3521b9de148f6df29b7bfccf3e6686.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/52e7654f07e90eb39a99679692bd6514.png)

![](copy3. 超参数调试、Batch正则化和程序框架.assets/10589b1fbdea44354e14a071a2244466.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/3642c894eee19fce479efa42b027b56f.png)

这还是刚才的代码，我稍微整理了一下，尽管这些函数或变量看上去有点神秘，但你在做编程练习时多练习几次就会熟悉起来了。

![](copy3. 超参数调试、Batch正则化和程序框架.assets/b276862d4e931b4b94a7a8d216e2812e.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/013bdedd956d27f8783b2828e6399458.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/421ad00776a97e6cd4fd926e35a5a419.png)
...
![](copy3. 超参数调试、Batch正则化和程序框架.assets/c7c804ba2a909bb914efbfd76eb57784.png)
