...
![](copy1. 深度学习的实践层面.assets/L2_week1_1.png)
...
![](copy1. 深度学习的实践层面.assets/L2_week1_2.png)
...
![](copy1. 深度学习的实践层面.assets/97596da07232f85d566710ee7dd2f8ad.png)
...
![](copy1. 深度学习的实践层面.assets/072653e2e9402d2857bfcb7b9f783a5c.png)
...
![](copy1. 深度学习的实践层面.assets/ebbfb8514ff5a983f41e938d5870b79d.png)
...
![](copy1. 深度学习的实践层面.assets/1224fb0922d5673c380e6dad9ded0b6b.png)
...
![](copy1. 深度学习的实践层面.assets/459ffc8998b35b259bc3bab4fd4fb44c.png)
...
![](copy1. 深度学习的实践层面.assets/658fc77a1ea588d5768dcd1a9a90761a.png)
...
![](copy1. 深度学习的实践层面.assets/02556a7f525c0ec016483644755c2231.png)
...
![](copy1. 深度学习的实践层面.assets/e0ec4205933b7c2a9eaed9fbaa8d4afc.png)
...
![](copy1. 深度学习的实践层面.assets/05ac08b96177b5d0aaae7b7bfea64f3a.png)

在这样一个只有$x_1$和$x_2$两个特征的二维数据集中，我们可以绘制数据，将偏差和方差可视化。在多维空间数据中，绘制数据和可视化分割边界无法实现，但我们可以通过几个指标，来研究偏差和方差。

![](copy1. 深度学习的实践层面.assets/2efd9728b5f07f914903dde309167a5d.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/c61d149beecddb96f0f93944320cf639.png)
...
![](copy1. 深度学习的实践层面.assets/fcdc2a7afbaaa07ca08b078bb4d37e8d.png)
...
![](copy1. 深度学习的实践层面.assets/f8fdbf9ed01b8634573125e0fb2ca860.png)

我们之前讲过，这样的分类器，会产生高偏差，因为它的数据拟合度低，像这种接近线性的分类器，数据拟合度低。

![](copy1. 深度学习的实践层面.assets/e9451f36e8baa41b74c95d9a09b0f028.png)

但是如果我们稍微改变一下分类器，我用紫色笔画出，它会过度拟合部分数据，用紫色线画出的分类器具有高偏差和高方差，偏差高是因为它几乎是一条线性分类器，并未拟合数据。

![](copy1. 深度学习的实践层面.assets/6e86aa7d9b21b1a49bf4a084c7503527.png)

这种二次曲线能够很好地拟合数据。

![](copy1. 深度学习的实践层面.assets/67dc5997a956314e238e6fc362f9883d.png)

这条曲线中间部分灵活性非常高，却过度拟合了这两个样本，这类分类器偏差很高，因为它几乎是线性的。

![](copy1. 深度学习的实践层面.assets/6bf7e092ddf93104ea64a5ddecbb7c6d.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/L2_week1_8.png)

这是我在训练神经网络时用到的基本方法，初始模型训练完成后，我首先要知道算法的偏差高不高，如果偏差较高，试着评估训练集或训练数据的性能。如果偏差的确很高，甚至无法拟合训练集，那么你要做的就是选择一个新的网络，比如含有更多隐藏层或者隐藏单元的网络，或者花费更多时间来训练网络，或者尝试更先进的优化算法，后面我们会讲到这部分内容。你也可以尝试其他方法，可能有用，也可能没用。
...
![](copy1. 深度学习的实践层面.assets/fa185e95684bbe6c0e9100164aff2ee5.png)
...
![](copy1. 深度学习的实践层面.assets/84c4e19130a91a09120087dd704bbaa4.png)
...
![](copy1. 深度学习的实践层面.assets/5190dbc5a98db7a248499f54a04257cc.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/2e88bd6f30a8ff8014d6d7dbe6d0488a.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/a8336b2cfeed4128a23f20fab843d226.png)

我们看下求和公式的具体参数，第一个求和符号其值$i$从1到$n^{[l - 1]}$，第二个其$J$值从1到$n^{[l]}$，因为$W$是一个$n^{[l]}\times n^{[l-1]}$的多维矩阵，$n^{[l]}$表示$l$ 层单元的数量，$n^{[l-1]}$表示第$l-1$层隐藏单元的数量。

![](copy1. 深度学习的实践层面.assets/5663bd9360df02b7e5a04c01d4e1bbc7.png)
...
![](copy1. 深度学习的实践层面.assets/dffec3cca0e523e22646704e5e76c39a.png)
...
![](copy1. 深度学习的实践层面.assets/b6856a371ed552fd6b9ada2068ab4c2c.png)
...
![](copy1. 深度学习的实践层面.assets/dafb163da5b9c3ece677a7ebce05b680.png)

我们用$ dW^{[l]}$的定义替换此处的$dW^{[l]}$，可以看到，$W^{[l]}$的定义被更新为$W^{[l]}$减去学习率$\alpha$ 乘以**backprop** 再加上$\frac{\lambda}{m}W^{[l]}$。

![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/f752bc74e0978320a72bcb15d1777cf8.png)
...
![](copy1. 深度学习的实践层面.assets/cba0f1c7a480139acb04e762e4fe57f8.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/15d5607b8ac1c1fbaa023cb6060633f2.png)

![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/1a6c47e64293cde6a0facb3872701db2.png)

左图是高偏差，右图是高方差，中间是**Just Right**，这几张图我们在前面课程中看到过。

![](copy1. 深度学习的实践层面.assets/d5ee6f2b60ff7601d50967f4365d0ecb.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/2aafa244c3f184cc271b26d1d95d70c9.png)

我们再来直观感受一下，正则化为什么可以预防过拟合，假设我们用的是这样的双曲线激活函数。

![](copy1. 深度学习的实践层面.assets/f35d94efc03123e4a5de6496c1b896c0.png)

用$g(z)$表示$tanh(z)$，我们发现如果 _z_ 非常小，比如 _z_ 只涉及很小范围的参数（图中原点附近的红色区域），这里我们利用了双曲正切函数的线性状态，只要$z$可以扩展为这样的更大值或者更小值，激活函数开始变得非线性。

![](copy1. 深度学习的实践层面.assets/884d5768243f4badc77356f843cb8c0c.png)

现在你应该摒弃这个直觉，如果正则化参数λ很大，激活函数的参数会相对较小，因为代价函数中的参数变大了，如果$W$很小，

![](copy1. 深度学习的实践层面.assets/63fa65e2609fe7a6909544247855d1a5.png)

如果$W$很小，相对来说，$z$也会很小。

![](copy1. 深度学习的实践层面.assets/fcdff0820223fb8a5756ad0bf99991fe.png)

特别是，如果$z$的值最终在这个范围内，都是相对较小的值，$g(z)$大致呈线性，每层几乎都是线性的，和线性回归函数一样。

![](copy1. 深度学习的实践层面.assets/8248be8e83121535b73969a4599fbb08.png)
...
![](copy1. 深度学习的实践层面.assets/307675386a412e57cf60be3381f02a64.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/b84cc50eb967cd177007e21e93960b5c.png)
...
![](copy1. 深度学习的实践层面.assets/97e37bf0d2893f890561cda932ba8c42.png)
...
![](copy1. 深度学习的实践层面.assets/e45f9a948989b365650ddf16f62b097e.png)

![](copy1. 深度学习的实践层面.assets/9fa7196adeeaf88eb386fda2e9fa9909.png)
...
![](copy1. 深度学习的实践层面.assets/70b248490e496fed9b8d1d616e4d8303.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/c75fe55c6bc17b60b00f5360aab180f4.png)
...
![](copy1. 深度学习的实践层面.assets/6ba17ffcb3ff22a4a0ec857e66946086.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/272d902720be9993454c6d9a5f0bec49.png)
...
![](copy1. 深度学习的实践层面.assets/de49d4e160f29544055819c5ab1dd9c0.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/L2_week1_16.png)
...
![](copy1. 深度学习的实践层面.assets/9b9f963a73e3ef9fcac008b179b6cf74.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/5fcb1441866d6d3eff1164ed4ea38cfe.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/13987e28fa537a110c6b123fc4455f7c.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/L2_week1_17.png)
...
![](copy1. 深度学习的实践层面.assets/2e2ccf4a2bb9156f876321ce07b006ca.png)
...
![](copy1. 深度学习的实践层面.assets/dd9a0f8209e53fdab8030b98d39e11eb.png)
...
![](copy1. 深度学习的实践层面.assets/69d92a8de8f62ab602d2bc022591d3c9.png)
...
![](copy1. 深度学习的实践层面.assets/9d0db64a9c9b050466a039c935f36f93.png)
...
![](copy1. 深度学习的实践层面.assets/51ca931387ed9fb80313263113c56e8e.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/f5fd5df8235145c54aece1a5bf7b31f6.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/L2_week1_19.png)

第一步是零均值化，$\mu = \frac{1}{m}\sum_{i =1}^{m}x^{(i)}$，它是一个向量，$x$等于每个训练数据 $x$减去$\mu$，意思是移动训练集，直到它完成零均值化。

![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/5e49434607f22caf087f7730177931bf.png)
...
![](copy1. 深度学习的实践层面.assets/bc4eccfb6c9dbef6cc81636d5ce60390.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/4d0c183882a140ecd205f1618243d7f8.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/fc03196f0b6d1c9f56fa39d0d462cfa4.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/ff87a8ea1377053128cdbf5129f0203f.png)
...
![](copy1. 深度学习的实践层面.assets/db9472c81a2cf6bb704dc398ea1cf017.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/e4114d7dc1c6242bd96cdadb457b8959.png)

结果，如果你是用的是**Relu**激活函数，方差设置为$\frac{2}{n}$，而不是$\frac{1}{n}$，效果会更好。你常常发现，初始化时，尤其是使用**Relu**激活函数时，$g^{[l]}(z) =Relu(z)$,它取决于你对随机变量的熟悉程度，这是高斯随机变量，然后乘以它的平方根，也就是引用这个方差$\frac{2}{n}$。这里，我用的是$n^{[l - 1]}$，因为本例中，逻辑回归的特征是不变的。但一般情况下$l$层上的每个神经元都有$n^{[l - 1]}$个输入。如果激活函数的输入特征被零均值和标准方差化，方差是1，$z$也会调整到相似范围，这就没解决问题（梯度消失和爆炸问题）。但它确实降低了梯度消失和爆炸问题，因为它给权重矩阵$w$设置了合理值，你也知道，它不能比1大很多，也不能比1小很多，所以梯度没有爆炸或消失过快。

![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/3decc82bf6f48903ee1fedbdb7e2c0f6.png)
...
![](copy1. 深度学习的实践层面.assets/91cde35a0fc9c11a98f16ad2797f20a7.png)
...
![](copy1. 深度学习的实践层面.assets/b24ad9ce9fdc4a32be4d98915d8f6ffb.png)
...
![](copy1. 深度学习的实践层面.assets/35a2e86581eab4665634593870fe5180.png)
...
![](copy1. 深度学习的实践层面.assets/1b2617461ed10089bc61ad273c84594f.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/94fb79f5694c802a5261298e54157e14.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/f56f0cdc90730068109a6e20fcd41724.png)
...
![](copy1. 深度学习的实践层面.assets/bed27b1d469acaf24dc1a7c1a7cdc086.png)
...
![](copy1. 深度学习的实践层面.assets/f223102bc7d144b66ad9b2ffa4a85f00.png)
...
![](copy1. 深度学习的实践层面.assets/07fd11e7b28ef0ab7d3b6d23b19a8fdc.png)
...
![](../../../../../../../01. 设计开发与数据生产/Develop/04. Project/Type/Artificial_Intelligence/01. 吴恩达深度学习/【附件】中文笔记 - 黄海广整理/deeplearning_ai_books-master/images/L2_week1_24.png)
