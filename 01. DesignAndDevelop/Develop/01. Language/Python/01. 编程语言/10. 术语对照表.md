...
可以被形参化的 [type](https://docs.python.org/zh-cn/3/glossary.html#term-type)；通常为容器类型例如 [`list`](https://docs.python.org/zh-cn/3/library/stdtypes.html#list)。 可用于 [类型提示](https://docs.python.org/zh-cn/3/glossary.html#term-type-hint) 和 [标注](https://docs.python.org/zh-cn/3/glossary.html#term-annotation)。 请参阅 [**PEP 483**](https://www.python.org/dev/peps/pep-0483) 来了解详情，以及 [`typing`](https://docs.python.org/zh-cn/3/library/typing.html#module-typing) 或 [泛型别名类型](https://docs.python.org/zh-cn/3/library/stdtypes.html#types-genericalias) 来了解其用法。
