...
![img](README.assets/d3279ad754257977f98e702cb156e9cf.png)
...
- 方案二：普通哈希算法
  - 缺点：如果节点数量发生了变化，也就是在对系统做扩容或者缩容时，必须迁移改变了映射关系的数据
...
![img](README.assets/025ddcaabece1f4b5823dfb1fb7340ef.png)
...
![img](README.assets/ed14c96417e08b4f916e0cd23d12b7bd.png)

当 3 个节点不能满足业务需求了，这时我们增加了一个节点，节点的数量从 3 变化为 4，意味取模哈希函数中基数的变化，这样会导致**大部分映射关系改变**，如下图：

![img](README.assets/392c54cfb9ec47f5191008aa1d27d6b5.png)
...
![img](README.assets/0ea3960fef48d4cbaeb4bec4345301e7.png)
...
![img](README.assets/83d7f363643353c92d252e34f1d4f687.png)
...
![img](README.assets/30c2c70721c12f9c140358fbdc5f2282.png)
...
![img](README.assets/f8909edef2f3949f8945bb99380baab3.png)

你可以看到，key-01、key-03 都不受影响，只有 key-02  需要被迁移节点 D。

假设节点数量从 3 减少到了 2，比如将节点 A 移除：

![img](README.assets/31485046f1303b57d8aaeaab103ea7ab.png)
...
![img](README.assets/d528bae6fcec2357ba2eb8f324ad9fd5.png)
...
![img](README.assets/dbb57b8d6071d011d05eeadd93269e13.png)
