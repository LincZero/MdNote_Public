...
![dpdk core components architecture](README.assets/dpdk-core-components-architecture.svg)
...
![dpdk architecture](README.assets/dpdk-architecture.png)
...
![dpdk-sample-applications](README.assets/dpdk-sample-applications.jpg)
...
- [OVS-DPDK](https://tonydeng.github.io/sdn-handbook/dpdk/ovs-dpdk.html)
...
> 注: 本章内容大部分整理自《[深入浅出DPDK](https://www.amazon.cn/图书/dp/B01FQ9SMZO)》的读书笔记。

- 《[深入浅出DPDK](https://www.amazon.cn/图书/dp/B01FQ9SMZO)》
