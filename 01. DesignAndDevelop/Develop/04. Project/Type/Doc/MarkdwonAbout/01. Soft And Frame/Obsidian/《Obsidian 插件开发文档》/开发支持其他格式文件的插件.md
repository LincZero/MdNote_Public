...
- 使用 [TextFileView](https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh2.0/reference/typescript/classes/TextFileView.html) 去展示及编辑基于文本的文件格式。

## 前置准备

- [创建您的第一个插件](https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh2.0/getting-started/create-your-first-plugin.html)。
- 理解如何去创建基本的 [HTML 元素](https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh2.0/user-interface/html-elements.html)。

## 第一步 — 注册一个 `TextFileView`

[TextFileView](https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh2.0/reference/typescript/classes/TextFileView.html) 是一个用于从插件中读写文本文件的 [自定义视图](https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh2.0/user-interface/views.html)。在此步骤中，您将扩展 TextFileView 以及当用户打开一个 CSV 文件时通知 Obsidian 去使用它。
...
您可以通过把 HTML 标签插入到 TextFileView 中的 `contentEl` 属性中的方式将它们插入到视图中。要想获取更多关于如何创建 HTML 标签的信息，请查阅 [HTML 标签](https://luhaifeng666.github.io/obsidian-plugin-docs-zh/zh2.0/user-interface/html-elements.html) 这篇文档。
