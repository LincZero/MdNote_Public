...
![](copy1. 卷积神经网络.assets/373615de4e30035c662958ce39115fb4.png)

这是我们本节课将要学习的一些问题，你应该早就听说过图片分类，或者说图片识别。比如给出这张64×64的图片，让计算机去分辨出这是一只猫。

![](copy1. 卷积神经网络.assets/f8ff84bc95636d9e37e35daef5149164.png)
...
![](copy1. 卷积神经网络.assets/bf57536975bce32f78c9e66a2360e8a1.png)
...
![](copy1. 卷积神经网络.assets/f126bca19d15f113c0f0371fdf0833d8.png)
...
![](copy1. 卷积神经网络.assets/9dc51757210398f26ec96d13540beacb.png)
...
![](copy1. 卷积神经网络.assets/a4b8429a41f31afb14adaa9204f98c66.png)

在之前的视频中，我说过神经网络的前几层是如何检测边缘的，然后，后面的层有可能检测到物体的部分区域，更靠后的一些层可能检测到完整的物体，这个例子中就是人脸。在这个视频中，你会看到如何在一张图片中进行边缘检测。

![](copy1. 卷积神经网络.assets/47c14f666d56e509a6863e826502bda2.png)
...
![](copy1. 卷积神经网络.assets/7099a5373f2281626aa8ddd47a180571.png)

关于符号表示，有一些问题，在数学中“$*$”就是卷积的标准标志，但是在**Python**中，这个标识常常被用来表示乘法或者元素乘法。所以这个“$*$”有多层含义，它是一个重载符号，在这个视频中，当“$*$”表示卷积的时候我会特别说明。

![](copy1. 卷积神经网络.assets/d6ecaeb7228172a00bc3948e8b214a27.png)
...
![](copy1. 卷积神经网络.assets/2b4796e91703492fe5a87d4fd95fcd6b.png)

把这9个数加起来得到-5，当然，你可以把这9个数按任何顺序相加，我只是先写了第一列，然后第二列，第三列。

接下来，为了弄明白第二个元素是什么，你要把蓝色的方块，向右移动一步，像这样，把这些绿色的标记去掉：

![](copy1. 卷积神经网络.assets/ad626a7a5a1cda8eb679e15f953f84a7.png)

继续做同样的元素乘法，然后加起来，所以是 $0×1+5×1+7×1+1×0+8×0+2×0+2×(-1)+ 9×(-1)+5×(-1)=-4 $。

![](copy1. 卷积神经网络.assets/9aa008335e8a229d3818a61aaccc7173.png)

接下来也是一样，继续右移一步，把9个数的点积加起来得到0。

![](copy1. 卷积神经网络.assets/440160a5ee39c0cd09380ad496c02e00.png)

继续移得到8，验证一下：$2×1+9×1+5×1+7×0+3×0+1×0+4×(-1)+ 1×(-1)+ 3×(-1)=8$。

![](copy1. 卷积神经网络.assets/2d34d782d438191675289a0b4bffcd20.png)

接下来为了得到下一行的元素，现在把蓝色块下移，现在蓝色块在这个位置：

![](copy1. 卷积神经网络.assets/348ff3ef87dd57f40b0ed0e0571f7751.png)

重复进行元素乘法，然后加起来。通过这样做得到-10。再将其右移得到-2，接着是2，3。以此类推，这样计算完矩阵中的其他元素。

![](copy1. 卷积神经网络.assets/5f9c10d0986f003e5bd6fa87a9ffe04b.png)
...
![](copy1. 卷积神经网络.assets/fdfb1a469b84ac7c25482e5064f3d594.png)
...
![](copy1. 卷积神经网络.assets/50836692632e32453f0eefcbbf58551b.png)
...
![](copy1. 卷积神经网络.assets/0c8b5b8441557b671431d515aefa1e8a.png)
...
![](copy1. 卷积神经网络.assets/783267536976c27544bbe36ac758a48e.png)

还是上一个视频中的例子，这张6×6的图片，左边较亮，而右边较暗，将它与垂直边缘检测滤波器进行卷积，检测结果就显示在了右边这幅图的中间部分。

![](copy1. 卷积神经网络.assets/6a248e5698d1f61ac4ba0238363c4a37.png)
...
![](copy1. 卷积神经网络.assets/eb8668010205b08fbcbcde7c2bb1fee2.png)
...
![](copy1. 卷积神经网络.assets/20cea5b23b32153fe2a8b8707ef21b6f.png)
...
![](copy1. 卷积神经网络.assets/f889ad7011738a23d78070e8ed2df04e.png)
...
![](copy1. 卷积神经网络.assets/d21e2642815d03b15396f7998ba4459a.png)
...
![](copy1. 卷积神经网络.assets/170e076ceaeb70339baa7b25ad5f5e6c.png)
...
![](copy1. 卷积神经网络.assets/0b384788a0ebc6f19ba3d3aa0c49adca.png)
...
![](copy1. 卷积神经网络.assets/208104bae9256fba5d8e37e22a9f5408.png)
...
![](copy1. 卷积神经网络.assets/7043a30561c0e84e1c905e5723e51c6c.png)
...
![](copy1. 卷积神经网络.assets/0663e1a9e477e2737067d9e79194208d.png)
...
![](copy1. 卷积神经网络.assets/ca5382358f30c1349fff98d1e52366b4.png)
...
![](copy1. 卷积神经网络.assets/3c52cc84feb068790c17c950028daf31.png)

在我们的这个例子里，$n=7$，$p=0$，$f=3$，$s=2$，$\ \frac{7 + 0 - 3}{2} + 1 =3$，即3×3的输出。

![](copy1. 卷积神经网络.assets/16196714c202bb1c8022219394543bf5.png)
...
![](copy1. 卷积神经网络.assets/58810d826a00657957640fb931f792a7.png)
...
![](copy1. 卷积神经网络.assets/197a4ff81c7e793962516fc6e636830a.png)
...
![](copy1. 卷积神经网络.assets/42d89137318c0edc3c9ce05820e37a3e.png)
...
![](copy1. 卷积神经网络.assets/0750b2344d16400b2db885261b059f53.png)
...
![](copy1. 卷积神经网络.assets/2fd0c97947a3e8222e78d550a317366d.png)
...
![](copy1. 卷积神经网络.assets/d088cafb50cabd6837d95c03c953e920.png)
...
![](copy1. 卷积神经网络.assets/794b25829ae809f93ac69f81eee79cd1.png)
...
![](copy1. 卷积神经网络.assets/d590398749e3f5f3ac230ab25116c4b7.png)
...
![](copy1. 卷积神经网络.assets/47ee90bd4a3939254a10d4b808d475ff.png)

上节课，我们已经讲了如何通过两个过滤器卷积处理一个三维图像，并输出两个不同的4×4矩阵。假设使用第一个过滤器进行卷积，得到第一个4×4矩阵。使用第二个过滤器进行卷积得到另外一个4×4矩阵。

![](copy1. 卷积神经网络.assets/2e42ccefeeecd75656bc871e89723844.png)
...
![](copy1. 卷积神经网络.assets/1236aad1426bd324964091f1d9db2587.png)
...
![](copy1. 卷积神经网络.assets/f75c1c3fb38083e046d3497656ab4591.png)
...
![](copy1. 卷积神经网络.assets/d0241a6550665caeec21174158e96da9.png)
...
![](copy1. 卷积神经网络.assets/0582fe0191d4ffe37f29f0f8a8bdd69e.png)
...
![](copy1. 卷积神经网络.assets/53d04d8ee616c7468e5b92da95c0e22b.png)
...
![](copy1. 卷积神经网络.assets/254491a07bfca29fee5eb75cde43e3f9.png)
...
![](copy1. 卷积神经网络.assets/522eb892bf05adbb57f3ff51bd876149.png)
...
![](copy1. 卷积神经网络.assets/84aa3be646a1e61f880fb8ab77ac92c7.png)
...
![](copy1. 卷积神经网络.assets/2e56c91e1e90260de922b5055a37e5e4.png)
...
![](copy1. 卷积神经网络.assets/7181dca1d3663d558944cbfd428c4727.png)
...
![](copy1. 卷积神经网络.assets/f97b7dfd7775fea9f9d18d8b404ad4ef.png)
...
![](copy1. 卷积神经网络.assets/0c09c238ff2bcda0ddd9405d1a60b325.png)
...
![](copy1. 卷积神经网络.assets/02028431085fb7974b76156dd4974b68.png)
...
![](copy1. 卷积神经网络.assets/ac42ede86634922acf4d34b12025b34f.png)
...
![](copy1. 卷积神经网络.assets/9687f796debffce065daa8c654b9b7b7.png)
...
![](copy1. 卷积神经网络.assets/ad5cf6dd7ca9a8ef144d8d918b21b1bc.png)
...
![](copy1. 卷积神经网络.assets/dd39353b23464d32599738065bc87172.png)
...
![](copy1. 卷积神经网络.assets/a800c70b250dc43b7003aaeebb4eefc2.png)
...
![](copy1. 卷积神经网络.assets/c225755635059449e2a9a84135e2548e.png)
...
![](copy1. 卷积神经网络.assets/1b5bbeadd76a7d65d3201c1e3de467ca.png)
...
![](copy1. 卷积神经网络.assets/6bd58a754152e7f5cf55a8c5bbac3100.png)
...
![](copy1. 卷积神经网络.assets/a7a10b593562a00a1a29df9c422aa1a2.png)
...
![](copy1. 卷积神经网络.assets/4e3af8ce9e6ec2135c5437eb1f87af85.png)
...
![](copy1. 卷积神经网络.assets/445418bf9cd2eaa5a83f31c1f40757dc.png)
...
![](copy1. 卷积神经网络.assets/8071427c9477615d68b771454f43699f.png)
...
![](copy1. 卷积神经网络.assets/c6894969e33cfc84b16267b752baf644.png)
...
![](copy1. 卷积神经网络.assets/aa71fe522f85ea932e3797f4fd4f405c.png)
...
![](copy1. 卷积神经网络.assets/b715a532e64edaa241c27eef9fdc9bfd.png)
...
![](copy1. 卷积神经网络.assets/beedba9de67752b61ad0eede899eb4de.png)
...
![](copy1. 卷积神经网络.assets/8fd4c61773f0245c87871de14f0a2d03.png)
