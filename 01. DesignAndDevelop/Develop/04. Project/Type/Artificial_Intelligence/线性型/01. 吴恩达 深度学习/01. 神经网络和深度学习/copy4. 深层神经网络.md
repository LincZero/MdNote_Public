...
![](copy4. 深层神经网络.assets/7c1cc04132b946baec5487ba68242362.png)

注意，神经网络的层数是这么定义的：**从左到右，由0开始定义**，比如上边右图，${x}_{1}$、${x}_{2}$、${x}_{3}$,这层是第0层，这层左边的隐藏层是第1层，由此类推。如下图左边是两个隐藏层的神经网络，右边是5个隐藏层的神经网络。

![](copy4. 深层神经网络.assets/be71cf997759e4aeaa4be1123c6bb6ba.png)
...
![](copy4. 深层神经网络.assets/9927bcb34e8e5bfe872937fccd693081.png)
...
![](copy4. 深层神经网络.assets/7cfc4b5fe94dcd9fe7130ac52701fed5.png)
...
![](copy4. 深层神经网络.assets/c13d2a8fa258125a5398030c97101ee1.png)
...
![](copy4. 深层神经网络.assets/53a5b4c71c0facfc8145af3b534f8583.png)
...
![](copy4. 深层神经网络.assets/faf2d5a697d1bd75aee46865f3a73a25.png)
...
![](copy4. 深层神经网络.assets/5ee7a8073518e36a98d4225eaf0f3063.png)
...
![](copy4. 深层神经网络.assets/fb680729409dc3912fd5a3d0c13b620a.png)
...
![](copy4. 深层神经网络.assets/563823fb44e05835948366f087f17e5c.png)
...
![](copy4. 深层神经网络.assets/595d105074eda2e4a11da9592fd5e444.png)

这种从简单到复杂的金字塔状表示方法或者组成方法，也可以应用在图像或者人脸识别以外的其他数据上。

比如当你想要建一个语音识别系统的时候，需要解决的就是如何可视化语音，比如你输入一个音频片段，那么神经网络的第一层可能就会去先开始试着探测比较低层次的音频波形的一些特征，比如音调是变高了还是低了，分辨白噪音，咝咝咝的声音，或者音调，可以选择这些相对程度比较低的波形特征，然后把这些波形组合在一起就能去探测声音的基本单元。在语言学中有个概念叫做音位，比如说单词ca，c的发音，“嗑”就是一个音位，a的发音“啊”是个音位，t的发音“特”也是个音位，有了基本的声音单元以后，组合起来，你就能识别音频当中的单词，单词再组合起来就能识别词组，再到完整的句子。

![](copy4. 深层神经网络.assets/bbdec09feac2176ad9578e93c1ee8c04.png)
...
![](copy4. 深层神经网络.assets/b409b7c0d05217ea37f0036691c891ca.png)
...
![](copy4. 深层神经网络.assets/2922198c51ca18fb64dcc7f4cc46d507.png)
...
![](copy4. 深层神经网络.assets/f1c14c92b1735648c05db7741f7d2871.png)

然后如果实现了这两个函数（正向和反向），然后神经网络的计算过程会是这样的：

![](copy4. 深层神经网络.assets/0b59199835620b12c781b3190a3fca1c.png)
...
![](copy4. 深层神经网络.assets/be2f6c7a8ff3c58e952208d5d59b19ce.png)
...
神经网络的一步训练包含了，从$a^{[0]}$开始，也就是 $x$ 然后经过一系列正向传播计算得到$\hat y$，之后再用输出值计算这个（第二行最后方块），再实现反向传播。现在你就有所有的导数项了，$W$也会在每一层被更新为$W=W-α~dW$，$b$也一样，$b=b-α~db$，反向传播就都计算完毕，我们有所有的导数值，那么这是神经网络一个梯度下降循环。
...
![](copy4. 深层神经网络.assets/db01a2dc79c2fa25a5d63bbee8a2cbd1.png)

如何寻找超参数的最优值？

![](copy4. 深层神经网络.assets/ae4feaf4f2a54f43f11639570a7caa45.png)
...
![](copy4. 深层神经网络.assets/dba07501564b5a11b80c6cca8e5bec14.png)
