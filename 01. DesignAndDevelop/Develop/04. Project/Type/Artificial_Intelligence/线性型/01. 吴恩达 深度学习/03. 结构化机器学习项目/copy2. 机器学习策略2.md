...
![](copy2. 机器学习策略2.assets/a1e634aa2ebe9336bf161f10d676928f.png)
...
![](copy2. 机器学习策略2.assets/ef3a1a483263b2693ecb6c7c1aecc565.png)
...
![](copy2. 机器学习策略2.assets/4502737a321a0f6269ee11cb8f140827.png)
...
![](copy2. 机器学习策略2.assets/d8f6d23ebbf3031932034f29f1630dc2.png)
...
![](copy2. 机器学习策略2.assets/56f907e76f4fc8f589f1930128f77a98.png)
...
![](copy2. 机器学习策略2.assets/a9cd24c7602100aaa8fb69eb03a3c47c.png)
...
![](copy2. 机器学习策略2.assets/e5c7f1005d695914f4a2fc988aa46821.png)
...
![](copy2. 机器学习策略2.assets/fc5d8fbd1124120e01fc4287896faa44.png)
...
![](copy2. 机器学习策略2.assets/08c2b44a5718781eb81fe4d0a2bccdde.png)
...
![](copy2. 机器学习策略2.assets/9d5b710121594f5a1e1bc5e901be52a8.png)
...
![](copy2. 机器学习策略2.assets/55478871edfd7d384494967008c96972.png)
...
![](copy2. 机器学习策略2.assets/9a5fd355b0d3a39a021ded507178343d.png)
...
![](copy2. 机器学习策略2.assets/4307a97cb4f2e2d6abc7b8ff28b0ca87.png)
...
![](copy2. 机器学习策略2.assets/9a6cbca750b289408a25789e224aeefc.png)
...
![](copy2. 机器学习策略2.assets/57c4cad6f0df4dc06ecf90c4f2d81a68.png)
...
![](copy2. 机器学习策略2.assets/eb0178687dedc450e1c184b958adeef3.png)
...
![](copy2. 机器学习策略2.assets/53d43ef349533237ceff7efac6341046.png)
...
![](copy2. 机器学习策略2.assets/50c5e70da71a16f0af95b3be038488a9.png)
...
![](copy2. 机器学习策略2.assets/ca34742f5f0b19239de5779dc80ad4d9.png)
...
![](copy2. 机器学习策略2.assets/5cbede5222b199f84dc491e0550435b6.png)
...
![](copy2. 机器学习策略2.assets/b997fa8695062ca7332b18d51767b7df.png)
...
![](copy2. 机器学习策略2.assets/5bbfa44bc294dd33f01346b1aa87d930.png)
...
![](copy2. 机器学习策略2.assets/347df851fe3809b308850a9e14cfdbb0.png)
...
![](copy2. 机器学习策略2.assets/ee5988fbe0d84a4e3a3546b547bdd9fa.png)
...
![](copy2. 机器学习策略2.assets/019a324b983247e11da7ad373426b756.png)
...
![](copy2. 机器学习策略2.assets/e8e1e932abb7a0bb44cab6403657321d.png)
...
![](copy2. 机器学习策略2.assets/b78b8300183ba2567c53db33d29f99d6.png)
...
![](copy2. 机器学习策略2.assets/a00d07267facb3d289ba1bef8071fb34.png)
...
![](copy2. 机器学习策略2.assets/cfd503f877d21d96821a81293ab0fdeb.png)
...
![](copy2. 机器学习策略2.assets/2e500634d47cbadd95d435da88ca2e64.png)
...
![](copy2. 机器学习策略2.assets/b55897ab16a969f7472b07a5d1dbe869.png)
...
![](copy2. 机器学习策略2.assets/75b40fb715db667f7aeccf3da5f5afb7.png)
...
![](copy2. 机器学习策略2.assets/965626f5cf666ec7ed093e0f5a0d8b52.png)
...
![](copy2. 机器学习策略2.assets/9a6170eeede895e437c8b0e4ef972316.png)
...
![](copy2. 机器学习策略2.assets/b2e28a9caf2b9a25e22e499e86d7c131.png)
...
![](copy2. 机器学习策略2.assets/a4e496893ed0fb928300f59f26f89cf1.png)

我们来看一个例子，假设你在研发无人驾驶车辆，那么你的无人驾驶车可能需要同时检测不同的物体，比如检测行人、车辆、停车标志，还有交通灯各种其他东西。比如在左边这个例子中，图像里有个停车标志，然后图像中有辆车，但没有行人，也没有交通灯。

![](copy2. 机器学习策略2.assets/f82865ea25c1f62b7e1981df0609a3e2.png)
...
![](copy2. 机器学习策略2.assets/c818eb171eff10f2762ede47c5a28a6f.png)
...
![](copy2. 机器学习策略2.assets/f25a0a781024508b02c8ff42011474e0.png)
...
![](copy2. 机器学习策略2.assets/91f56940e94af25b0d7a46fa8dde9075.png)
...
![](copy2. 机器学习策略2.assets/dbca02c8a624c00bdf088c56c8122609.png)
...
![](copy2. 机器学习策略2.assets/a4f0d10a340481a4189328870259d0ed.png)
...
![](copy2. 机器学习策略2.assets/925b9078df981f43f5c573833d0aa9ff.png)
...
![](copy2. 机器学习策略2.assets/c31b0402d98fb34aecf167e65f83cb37.png)
...
![](copy2. 机器学习策略2.assets/4ad6502dd05f5aac0c2d649d3c126250.png)
...
![](copy2. 机器学习策略2.assets/14d6a403472dd79bdab9f7bd8e74bf75.jpg)
...
![](copy2. 机器学习策略2.assets/cf8285f8ce5a45ba016d3b8509a766be.png)
...
![](copy2. 机器学习策略2.assets/06720034b609c3c637afcbc15c44fe72.png)
...
![](copy2. 机器学习策略2.assets/4ca915fa995cc2b6edb8b0282cdaf7c5.png)
...
![](copy2. 机器学习策略2.assets/803377bbfc2a9f9608cd9ac4dbfaefc3.png)
...
![](copy2. 机器学习策略2.assets/188a6112bc3e3065f5ddfca87d8c9064.png)
...
![](copy2. 机器学习策略2.assets/3ea6f681c550cf04808756a9e9738b77.png)
...
![](copy2. 机器学习策略2.assets/2211e8807cc6d4c2c0941625e2de4860.png)
...
![](copy2. 机器学习策略2.assets/b73c65c89f8af6e000369e12f0303409.png)
...
![](copy2. 机器学习策略2.assets/93e5f8097f3246be83f704e468e72d76.png)
...
![](copy2. 机器学习策略2.assets/a32be685b5f17ec3a442a858d96aa3ce.png)
...
![](copy2. 机器学习策略2.assets/48dd5cbbc5946d02552c0a74509be205.png)
